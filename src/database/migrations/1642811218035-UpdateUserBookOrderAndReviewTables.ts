...
export class UpdateUserBookOrderAndReviewTables1642811218035 implements MigrationInterface {
    name = 'UpdateUserBookOrderAndReviewTables1642811218035'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "review" integer NOT NULL, "comment" character varying NOT NULL, "user_id" character varying NOT NULL, "book_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "bookId" uuid, "userId" uuid, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
